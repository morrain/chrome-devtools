...
2. 在该节点上右键，选择**Break on**>**Subtree Modifications**选项，该节点最左侧显示一个蓝色的图标(![](https://developers.google.cn/web/tools/chrome-devtools/javascript/imgs/dom-breakpoint-icon.png)) 
